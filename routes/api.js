...
var creatorList = ['@hebom','@haebom','@itsme.haebom','@hebom.cakep', '@hebommm','@hebom','@haebomm', '@haebom'];
var creator = ['HAEBOM'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'APIKEY INVALID chat gw aja yaaa di wa.me/6281314388515 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
router.get('/cekapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		...
		message: 'jangan lupa follow ig @itsme.haebom'
	})
} else {
	json = JSON.stringify({
		status: false
